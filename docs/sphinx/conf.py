...
.. |mugatu_version| replace:: {__version__}
"""
...
htmlhelp_basename = '{0}pdoc'.format('mugatu')
...
man_pages = [
    (master_doc, 'mugatu', u'{0} Documentation'.format(project),
     [author], 1)
]
...
if use_releases == 'yes':
    ...
    releases_github_path = 'sdss/mugatu'
